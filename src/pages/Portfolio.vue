    ...
    <q-layout view="hHh Lpr lff">
      <q-page-container class="scroll overflow-hidden">
        <q-drawer
          ...
          no-swipe-open
          no-swipe-close
          class="bg-light-blue-5 text-white q-pt-xl q-mt-xl q-pb-xl q-mb-xl shadow-4"
        >
                  ...
                  <q-item-section>
                    ...
                    <q-item dense>
                      <q-img
                        :src="project.image"
                        :height="
                          mini ? '50px' : $q.screen.lt.sm ? '120px' : '200px'
                        "
                        :width="
                          mini ? '50px' : $q.screen.lt.sm ? '120px' : '100%'
                        "
        ...
        <q-page padding>
          <h4
            class="q-pl-md text-h3 text-weight-light text-uppercase text-blue-grey"
          >
            Portfolio
          </h4>
          <p class="q-pl-md text-subtitle1 text-blue-grey">
            Click the images on the sidebar to view that project's details.
          </p>
          <q-separator />
          ...
          <q-layout view="hHh lpR fFf" class="q-mt-lg text-center q-px-lg">
            ...
            <div>
              <q-badge
                ...
                :key="tech"
                :label="tech"
                class="q-mr-sm q-mt-sm q-pa-sm text-weight-bold shadow-2"
              />
            </div>
