  ...
  <section id="projects" ref="sectionRef" class="py-24 bg-[#12121a]">
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div class="mb-12 reveal">
        <p class="font-mono text-[#6366f1] text-sm tracking-[0.2em] uppercase mb-3">All Work</p>
        <h2 class="font-syne font-bold text-4xl md:text-5xl text-[#e4e4e7]">Projects</h2>
      </div>
      ...
      >
        ...
        >
          <div class="relative aspect-video overflow-hidden">
            ...
            />
            <div class="absolute inset-0 bg-[#f0b429]/0 group-hover:bg-[#f0b429]/10 transition-all duration-300"></div>
          </div>
          <div class="p-3 border-t border-[#1a1a2e]">
            <div class="font-syne font-semibold text-[#e4e4e7] text-sm truncate mb-1">{{ project.name }}</div>
            <div class="font-mono text-xs text-[#71717a]">{{ project.type }}</div>
          </div>
        </div>
      </TransitionGroup>
    </div>
